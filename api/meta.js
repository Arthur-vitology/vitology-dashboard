...
export default async function handler(req, res) {
  ...
  try {
    // Haal data op per campagne en tel zelf op
    // Zo vermijden we dat gearchiveerde/verwijderde campagnes meegeteld worden
    const fields = 'spend,impressions,clicks,ctr,cpc,campaign_name,campaign_id';
